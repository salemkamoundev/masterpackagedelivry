...
echo "🔒 Mise à jour de la sécurité Login (Blocage des comptes non validés)..."

# Mise à jour de LoginComponent pour vérifier isActive
...
echo "✅ Sécurité Login appliquée : Vérification du statut 'Actif' avant accès."