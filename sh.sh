...
TARGET_FILE="src/app/features/admin/trips/trip-manager.component.ts"
GREEN='\033[0;32m'
NC='\033[0m'
            ...
            <div class="p-6 overflow-y-auto">
                ...
                <div *ngIf="requestType==='PARCEL'" class="space-y-3 bg-gray-50 p-4 rounded-lg border border-gray-200">
                   ...
                   <div class="grid grid-cols-2 gap-3">
                     ...
                     <div>
                       <label class="text-xs font-bold text-gray-500 uppercase">Tél</label>
                ...
                <div *ngIf="requestType==='PASSENGER'" class="space-y-3 bg-indigo-50 p-4 rounded-lg border border-indigo-200">
                   <div class="grid grid-cols-2 gap-3">
                     <div>
                       ...
                       <input #passNameInput placeholder="Nom Prénom" class="w-full border border-gray-300 p-2 rounded focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                     </div>
                     <div>
                       <label class="text-xs font-bold text-gray-500 uppercase">Tél</label>
                   ...
                   <div>
                       ...
                       <input #passPickInput placeholder="Départ" class="w-full border border-gray-300 p-2 rounded focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                   </div>
                   <div>
