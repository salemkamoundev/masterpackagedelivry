...
echo "🌍 Écriture forcée du LiveMapComponent (Version Finale)..."

# On utilise 'EOF' entre quotes pour empêcher le shell d'interpréter les $ variables du code TS
...
echo "✅ LiveMap mis à jour avec la méthode sécurisée."
echo "⚠️  IMPORTANT : Veuillez arrêter le serveur (Ctrl+C) et relancer 'ng serve' pour voir les changements."